...
This is a blogging application inspired by Medium. The project is built from scratch using a modern tech stack.
...
### Installation
 ...
 1.  Clone the repository:
	    ...
	    git clone https://github.com/ShashankDahake7/MediumBlog.git
